...
This repository contains first year of **KPI University FICE** Labs.
...
- **Lab №5:** Shake sort algorithm that sorts main square matrix diagonal in non-ascending order. Program allows to create matrix with ascending, descending and random order.
